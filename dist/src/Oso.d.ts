...
import type { Options, Class, DataFilteringQueryParams } from './types';
/** The Oso authorization API. */
export declare class Oso<Actor = unknown, Action = unknown, Resource = unknown, Field = unknown, Request = unknown> extends Polar {
    #private;
     ...
     */
    authorizedQuery(actor: Actor, action: Action, resourceCls: Class<Resource>): Promise<unknown>;
    /**
     ...
     */
    authorizedResources<T extends Resource>(actor: Actor, action: Action, resourceCls: Class<T>): Promise<T[]>;
    /**
