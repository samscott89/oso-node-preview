...
var _Host_ffiPolar, _Host_instances, _Host_equalityFn;
Object.defineProperty(exports, "__esModule", { value: true });
exports.Host = exports.UserType = void 0;
...
class UserType {
    constructor({ name, cls, id, fields, buildQuery, execQuery, combineQuery, isaCheck }) {
        this.name = name;
        this.cls = cls;
        this.fields = fields;
        ...
        this.buildQuery = helpers_1.promisify1(buildQuery);
        this.execQuery = helpers_1.promisify1(execQuery);
...
class Host {
    ...
    constructor(ffiPolar, equalityFn) {
        ...
        this.types = new Map();
        this.buildQuery = () => {
            throw new errors_1.DataFilteringConfigurationError('buildQuery');
        };
        this.execQuery = () => {
            throw new errors_1.DataFilteringConfigurationError('execQuery');
        };
        this.combineQuery = () => {
            throw new errors_1.DataFilteringConfigurationError('combineQuery');
        };
    }
    /**
        ...
        for (const [tag, userType] of this.types) {
            if (helpers_1.isString(tag)) {
                ...
                for (const [k, v] of fields) {
                    if (v instanceof dataFiltering_1.Relation) {
    ...
    async isaWithPath(baseTag, path, classTag) {
        ...
        for (const fld of path) {
            ...
            if (fieldType === undefined)
                return false;
            if (fieldType instanceof dataFiltering_1.Relation) {
...
exports.Host = Host;
_Host_ffiPolar = new WeakMap(), _Host_instances = new WeakMap(), _Host_equalityFn = new WeakMap();
