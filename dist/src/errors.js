...
class DataFilteringConfigurationError extends PolarError {
    constructor(fn) {
        super(`Missing '${fn}' implementation. Did you forget to call \`Oso.setDataFilteringQueryDefaults()\`?`);
    }
}
