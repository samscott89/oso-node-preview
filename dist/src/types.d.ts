...
export declare type BuildQueryFn<Q = any> = (filters: Filter[]) => Q;
export declare type ExecQueryFn<Q = any, ReturnType = any> = (query: Q) => ReturnType;
export declare type CombineQueryFn<Q = any> = (a: Q, b: Q) => Q;
...
export declare type IsaCheck = (instance: any) => boolean;
/**
 ...
 */
export interface UserTypeParams<Type extends Class> extends Required<DataFilteringQueryParams> {
    /**
